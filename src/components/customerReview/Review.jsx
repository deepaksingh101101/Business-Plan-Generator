import { chat1,chat2,chat3,chat4,chat5,chat6 } from "../../assets/images";

const Review = () => {
  return (
    <div className="container mx-auto px-4 max-w-[1300px]">
      <h1 className="text-start text-[32px] lg:text-[54px] font-medium mb-6">What customers say about us</h1>
      ...
      <div className="flex justify-center items-center py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="flex flex-col p-8 rounded-3xl bg-[rgba(230,241,250,0.5)] transition-shadow duration-300 ease-in-out hover:shadow-xl">
